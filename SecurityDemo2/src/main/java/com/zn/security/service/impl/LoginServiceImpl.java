...
//        HashMap<String, String> map = new HashMap<>();
    ...
    @Override
    public BaseResult smsLogin(SmsCodeEntity smsCodeEntity) {


        SmsCodeAuthenticationToken authenticationToken = new SmsCodeAuthenticationToken(smsCodeEntity.getPhone(),smsCodeEntity.getCode());
        Authentication authenticate = authenticationManager.authenticate(authenticationToken);
